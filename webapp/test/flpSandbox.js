		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zcadalunocurso-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcadalunocurso-display": {
								"semanticObject": "zcadalunocurso",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcadalunocurso",
									"url": sap.ui.require.toUrl("zcadalunocurso")
								}
							}
						}
					}
